$( document ).ready(function() {
	...
	$.getJSON( "json/convertcsv.json", function(data) {
		...
		//makeDatePicker();
		addNewDataFromForm(data);
	});
	function addNewDataFromForm(data){
